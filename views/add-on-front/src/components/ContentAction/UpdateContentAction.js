...
export default function UpdateContentAction() {
  ...
  const getcontentAction = async () => {
    ...
    try {
      const { data } = await axios.get(
        ...
        }:5000/api/pfe/user/projects/contentActions/${
  ...
  const updatecontentAction = async () => {
    var arr = [];
    ...
    try {
      ...
      arr.length ? (input.paramter = arr):input.paramter=contentAction.paramter;
        ...
        <form className="sign-in-form">
          ...
          <div className="input-field">
            ...
            <input
              type="text"
              placeholder="name"
              defaultValue={contentAction && contentAction.name}
          ...
          <div className="input-field">
            ...
            <input
              type="text"
              placeholder="key"
              defaultValue={contentAction && contentAction.key}
          ...
          <div className="input-field">
            ...
            <input
              ...
              defaultValue={contentAction && contentAction.description}
